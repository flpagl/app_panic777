...
(function(t, e) {
    ...
    var e, i, a, o, n, r = "\n\nVisit documentation page to learn more: https://www.notiflix.com/documentation", s = "-apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\"", l = {
        ...
        t.document.getElementById(d.id) ? 0 === B && (t.document.getElementById(d.id).style.background = p.backOverlayColor || e.backOverlayColor) : t.document.body.appendChild(d)),
        ...
        if (e.useIcon) {
            var h = t.document.getElementById(x.id).querySelectorAll(".nmi")[0]
              , v = 40;
            if (e.useFontAwesome)
                v = Math.round(parseInt(h.offsetHeight));
            else {
                var N = h.getBBox();
                v = Math.round(parseInt(N.width))
            }
            var z = t.document.getElementById(x.id).querySelectorAll("span")[0]
              , C = Math.round(z.offsetHeight);
            C <= v && (z.style.paddingTop = (v - C) / 2 + "px",
            z.style.paddingBottom = (v - C) / 2 + "px")
        }
        if (t.document.getElementById(x.id)) {
            var S, W = t.document.getElementById(x.id), I = t.document.getElementById(f.id);
            e.backOverlay && (S = t.document.getElementById(d.id));
            var L, R, M = function() {
                W.classList.add("remove"),
                e.backOverlay && 0 >= I.childElementCount && S.classList.add("remove"),
                clearTimeout(L)
            }, X = function() {
                var i = t.document.getElementById(x.id);
                i && null !== W.parentNode && W.parentNode.removeChild(W),
                0 >= I.childElementCount && null !== I.parentNode && (I.parentNode.removeChild(I),
                e.backOverlay && null !== S.parentNode && S.parentNode.removeChild(S)),
                clearTimeout(R)
            };
            if (e.closeButton && "function" != typeof o) {
                var F = t.document.getElementById(x.id).querySelectorAll("span.notify-close-button")[0];
            ...
            ("function" == typeof o || e.clickToClose) && W.addEventListener("click", function() {
                "function" == typeof o && (B--,
                o()),
                M();
                var t = setTimeout(function() {
            ...
            e.closeButton || "function" == typeof o || (L = setTimeout(function() {
                M()
            }, e.timeout),
        ...
        if (e.showOnlyTheLastOne && 0 < A)
            for (var E, D = t.document.querySelectorAll("[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + A + "])"), T = 0; T < D.length; T++)
                E = D[T],
        ...
        i = y(!0, i, c)
    }, E = function(e, i, o, n, r, l, m, p, f) {
        if (!g("body"))
            return !1;
        a || H.Confirm.Init({});
        var d = y(!0, a, {});
        "object" != typeof m || Array.isArray(m) || (a = y(!0, a, m)),
        ...
        !t.document.getElementById(x.id)) {
            ...
            "function" == typeof r) {
                var S = t.document.getElementById("NXConfirmButtonCancel");
        ...
        if ("object" == typeof e && !Array.isArray(e) || "object" == typeof i && !Array.isArray(i)) {
            var m = {};
            "object" == typeof e ? m = e : "object" == typeof i && (m = i),
            o = y(!0, o, m)
        }
        var c = "";
        if ("string" == typeof e && 0 < e.length && (c = e),
        n) {
            c = c.toString().length > o.messageMaxLength ? k(c).toString().substring(0, o.messageMaxLength) + "..." : k(c).toString();
            var f = "";
            0 < c.length && (f = "<p id=\"" + o.messageID + "\" class=\"loading-message\" style=\"color:" + o.messageColor + ";font-size:" + o.messageFontSize + ";\">" + c + "</p>"),
            ...
            var b = parseInt((o.svgSize || "").replace(/[^0-9]/g, ""))
              , u = t.innerWidth
              , w = b >= u ? u - 40 + "px" : b + "px"
              , h = "<div style=\"width:" + w + "; height:" + w + ";\" class=\"" + o.className + "-icon" + (0 < c.length ? " with-message" : "") + "\">" + x + "</div>"
        ...
        if ("string" != typeof a || 1 > (a || "").length || 1 === (a || "").length && ("#" === (a || "")[0] || "." === (a || "")[0]))
            ...
            !1;
        var c = t.document.querySelectorAll(a);
        if (1 > c.length)
        ...
        if ("object" == typeof r && !Array.isArray(r) || "object" == typeof l && !Array.isArray(l)) {
            var b = {};
            "object" == typeof r ? b = r : "object" == typeof l && (b = l),
            n = y(!0, n, b)
        }
        var u = "";
        "string" == typeof r && 0 < r.length && (u = r),
        n.cssAnimation || (n.cssAnimationDuration = 0);
        var w = "notiflix-block";
        "string" == typeof n.className && (w = n.className.trim());
        var h = "number" == typeof n.querySelectorLimit ? n.querySelectorLimit : 200
          , v = c.length >= h ? h : c.length;
        if (e)
            for (var N = 0; N < v; N++) {
                var z = c[N]
                  , M = z.querySelectorAll("[id^=" + f.ID + "]");
                if (1 > M.length) {
                    var A = "";
                    o && ("hourglass" === o ? A = S(n.svgSize, n.svgColor) : "circle" === o ? A = W(n.svgSize, n.svgColor) : "arrows" === o ? A = I(n.svgSize, n.svgColor) : "dots" === o ? A = L(n.svgSize, n.svgColor) : "pulse" === o ? A = R(n.svgSize, n.svgColor) : A = C(n.svgSize, n.svgColor));
                    var B = "<span class=\"" + w + "-icon\" style=\"width:" + n.svgSize + ";height:" + n.svgSize + ";\">" + A + "</span>"
                      , X = "";
                    0 < u.length && (u = u.length > n.messageMaxLength ? k(u).substring(0, n.messageMaxLength) + "..." : k(u),
                    X = "<span style=\"font-size:" + n.messageFontSize + ";color:" + n.messageColor + ";\" class=\"" + w + "-message\">" + u + "</span>"),
                    j++;
                    var F = t.document.createElement("div");
                    F.id = f.ID + "-" + j,
                    F.className = w + "-wrap" + (n.cssAnimation ? " with-animation" : ""),
                    F.style.position = n.position,
                    F.style.zIndex = n.zindex,
                    F.style.background = n.backgroundColor,
                    F.style.animationDuration = n.cssAnimationDuration + "ms",
                    F.style.fontFamily = "\"" + n.fontFamily + "\", " + s,
                    F.style.display = "flex",
                    F.style.flexWrap = "wrap",
                    F.style.flexDirection = "column",
                    F.style.alignItems = "center",
                    F.style.justifyContent = "center",
                    n.rtl && (F.setAttribute("dir", "rtl"),
                    F.classList.add("rtl-on")),
                    F.innerHTML = B + X;
                    var E = t.getComputedStyle(z).getPropertyValue("position")
                      , D = "string" == typeof E ? E.toLocaleLowerCase("en") : "relative"
                      , T = Math.round(1.25 * parseInt(n.svgSize)) + 40
                      , O = z.offsetHeight || 0
                      , P = "";
                    T > O && (P = "min-height:" + T + "px;");
                    var Q = "";
                    Q = z.getAttribute("id") ? "#" + z.getAttribute("id") : z.classList[0] ? "." + z.classList[0] : (z.tagName || "").toLocaleLowerCase("en");
                    var Y = ""
                      , G = -1 >= ["absolute", "relative", "fixed", "sticky"].indexOf(D);
                    if (G || 0 < P.length) {
                        if (!g("head"))
                            return !1;
                        G && (Y = "position:relative!important;");
                        var U = "<style id=\"Style-" + f.ID + "-" + j + "\">" + Q + "." + w + "-position{" + Y + P + "}</style>"
                          , V = t.document.createRange();
                        V.selectNode(t.document.head);
                        var q = V.createContextualFragment(U);
                        t.document.head.appendChild(q),
                        z.classList.add(w + "-position")
                    }
                    z.appendChild(F)
                }
            }
